    ...
    <div className="min-h-screen bg-white text-black flex flex-col">
      ...
      <Link href="/Home">
        ...
        <div className="flex items-center">
          ...
          />
          <button className="bg-[#315CEA] text-white px-4 py-2 rounded-md">Masukkan Kupon</button>
        </div>
      </div>
      ...
      <div className="border p-4 rounded-md mt-6 w-80 ml-auto m-4">
        ...
        <Link href="/Checkout">
        <button className="bg-[#315CEA] text-white w-full py-2 mt-4 rounded-md flex items-center justify-center">
           Checkout
        </button>
        </Link>
      </div>
