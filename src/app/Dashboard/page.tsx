...
import { IoCartOutline, IoHeartOutline, IoPersonOutline,IoHomeOutline } from 'react-icons/io5';
        ...
        <aside className="w-64 bg-white text-gray-800 h-full">
          <div className="p-4">
            ...
            <ul>
              ...
              <li className="mb-2">
                <a href="/Produk" className="text-gray-600 hover:text-gray-800">
                  Produk Saya
                </a>
              </li>
              <li className="mb-2">
                <a href="/Tambahp" className="text-gray-600 hover:text-gray-800">
                  Tambah Produk Baru
                </a>
              </li>
            </ul>
        ...
        <main className="flex-1">
          ...
          <button>
           <IoHomeOutline className="text-gray-600 text-xl" />
                ...
                <IoHeartOutline className="text-gray-600 hover:text-gray-800" />
