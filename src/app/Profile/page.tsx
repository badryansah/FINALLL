      ...
      <header className="bg-white shadow-md">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex space-x-4">
            <IoHeartOutline className="text-gray-600 hover:text-gray-800" size={24} />
        ...
        <aside className="w-64 bg-white text-gray-800">
          <nav className="p-4">
            <ul className="space-y-4">
              ...
              <li className="mt-4 font-bold">Mulai Jual</li>
              <li>
                <Link href="/Produk" className="block px-4 py-2 hover:bg-gray-100 rounded">
                  Produk Saya
                </Link>
              </li>
              <li>
                <Link href="/Tambahp" className="block px-4 py-2 hover:bg-gray-100 rounded">
                  Tambah Produk Baru
                </Link>
              </li>
            </ul>
